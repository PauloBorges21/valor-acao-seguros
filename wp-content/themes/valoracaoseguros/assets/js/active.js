...
(function($) {
    "use strict";
     $(document).on('ready', function() {
		...
		$(".mobile-menu .slicknav_nav a").click(function () {
			if (width <= 900) {
				$(".header .slicknav_btn").click();
			}
		})
		...
		$(window).on('load', function() {
			...
			if ($.fn.isotope) {
					...
					$('.contact-nav ul li').on('click', function () {
						$(".contact-nav ul li").removeClass("active");
						$(this).addClass("active");
